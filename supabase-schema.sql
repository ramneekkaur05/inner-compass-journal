...
CREATE INDEX idx_year_highlights_user_year ON year_highlights(user_id, year);
CREATE INDEX idx_year_highlights_event_date ON year_highlights(event_date);
